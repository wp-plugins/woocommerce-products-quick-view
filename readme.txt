...
* Fancybox pop-up tool Ð canÕt be blocked by browser pop-up settings.
* Pop-up opens in 0.300 of a second and closes instantly.
* SEO tracking Ð Your analytics tracking code e.g. Google records every view.
...
* Mobile device optimized Ð all tablets and phones
...
[Support](https://a3rev.com/forums/forum/woocommerce-plugins/quick-view-ultimate/)
...
2. On wp-admin click on WooCommerce > Settings > Quick View Tab
